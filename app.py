        ...
        if selected_patient_id:
            ...
            try:
                ...
                if patient_record:
                    ...
                    tabs = st.tabs(["Summary Report","Clinical Summary", "Diagnostic Information", "Treatment Plan", "Conversation"])
                    with tabs[0]:
...
def show_browser_page():
    ...
    # Load metadata with refresh if needed
    metadata_list = load_metadata(refresh=st.session_state.refresh_data)
        ...
        with st.spinner("🔍 Analyzing data..."):
            try:
                ...
                if not result:
                    ...
                    # Step 3: Create individual JSON files
                    ...
                    tabs = st.tabs(["Summary", "Full JSON"])
                    ...
                    with tabs[0]:
                        ...
                        st.write(f"**Summary:** {result.get('structured_data', {}).get('SummaryNarrative', {}).get('ClinicalCourseProgression', 'N/A')}")

                    with tabs[1]:
                        st.json(result)

                    # Step 7: Refresh metadata cache
